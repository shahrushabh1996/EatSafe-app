...
class ImageService {
  // Static flag to prevent concurrent image capture operations
  static bool _isProcessingImage = false;
  ...
  static Future<void> processImageCapture(BuildContext context, ImageSource source) async {
    ...
    // If already processing an image, return early to prevent multiple dialogs
    if (_isProcessingImage) {
      print('Image capture already in progress, ignoring this request');
      return;
    }
